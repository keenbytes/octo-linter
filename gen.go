...
func main() {
	...
	tplObj := struct {
		...
		Rules: map[string]S{
			...
			"naming_conventions__action_input_name_format":                            {N: "naming.Action", F: map[string]string{"Field": `naming.ActionFieldInputName`}},
			"naming_conventions__action_output_name_format":                           {N: "naming.Action", F: map[string]string{"Field": `naming.ActionFieldOutputName`}},
			"naming_conventions__action_referenced_variable_format":                   {N: "naming.Action", F: map[string]string{"Field": `naming.ActionFieldReferencedVariable`}},
			"naming_conventions__action_step_env_format":                              {N: "naming.Action", F: map[string]string{"Field": `naming.ActionFieldStepEnv`}},
			"naming_conventions__workflow_env_format":                                 {N: "naming.Workflow", F: map[string]string{"Field": `naming.WorkflowFieldEnv`}},
			"naming_conventions__workflow_job_env_format":                             {N: "naming.Workflow", F: map[string]string{"Field": `naming.WorkflowFieldJobEnv`}},
			"naming_conventions__workflow_job_step_env_format":                        {N: "naming.Workflow", F: map[string]string{"Field": `naming.WorkflowFieldJobStepEnv`}},
			"naming_conventions__workflow_referenced_variable_format":                 {N: "naming.Workflow", F: map[string]string{"Field": `naming.WorkflowFieldReferencedVariable`}},
			"naming_conventions__workflow_dispatch_input_name_format":                 {N: "naming.Workflow", F: map[string]string{"Field": `naming.WorkflowFieldDispatchInputName`}},
			"naming_conventions__workflow_call_input_name_format":                     {N: "naming.Workflow", F: map[string]string{"Field": `naming.WorkflowFieldCallInputName`}},
			"naming_conventions__workflow_job_name_format":                            {N: "naming.Workflow", F: map[string]string{"Field": `naming.WorkflowFieldJobName`}},
			"naming_conventions__workflow_single_job_only_name":                       {N: "naming.WorkflowSingleJobOnlyName"},
			"required_fields__action_requires":                                        {N: "required.Action", F: map[string]string{"Field": `required.ActionFieldAction`}},
			"required_fields__action_input_requires":                                  {N: "required.Action", F: map[string]string{"Field": `required.ActionFieldInput`}},
			"required_fields__action_output_requires":                                 {N: "required.Action", F: map[string]string{"Field": `required.ActionFieldOutput`}},
			"required_fields__workflow_requires":                                      {N: "required.Workflow", F: map[string]string{"Field": `required.WorkflowFieldWorkflow`}},
			"required_fields__workflow_dispatch_input_requires":                       {N: "required.Workflow", F: map[string]string{"Field": `required.WorkflowFieldDispatchInput`}},
			"required_fields__workflow_call_input_requires":                           {N: "required.Workflow", F: map[string]string{"Field": `required.WorkflowFieldCallInput`}},
